...
(function($) {
    $.entwine('ss', function($) {
        MadeUtils.MarkDownLink = {

            'CodeMirror'                : null,

            LinkDialog : function(codemirror){
                MadeUtils.MarkDownLink.CodeMirror = codemirror;
                ...
                if(dialog.length) {
                    dialog.open();
                    MadeUtils.MarkDownLink.SetDefaultValues(dialog);
                } else {
            ...
            SetDefaultValues: function(dialog){
                var codeMirror = MadeUtils.MarkDownLink.CodeMirror;
        ...
        $('form.markdowneditorfield-linkform').entwine({
            ...
            onsubmit: function(e) {
                ...
                var cm = MadeUtils.MarkDownLink.CodeMirror;
        ...
        $('textarea.markdowneditor').entwine({
            onmatch: function() {
//                MadeUtils.MarkDownLink.InitField(jQuery(this));
            }
        });
...
function drawCMSLink(editor){
    var cm = editor.codemirror;
    MadeUtils.MarkDownLink.LinkDialog(cm);
}
